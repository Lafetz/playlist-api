...
export const createSongHandler = [
  ...validateSongCreate,
  validateRequest,
...
export const getSongsHandler = [
  ...
  async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      const songs = await SongService.getSongs(playlistId as string, {
        offset: pageNumber,
        limit: limitNumber,
        //@ts-ignore
        sort: sortOption,
